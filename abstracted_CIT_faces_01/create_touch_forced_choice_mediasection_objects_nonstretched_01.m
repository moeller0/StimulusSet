...
abs_img_path_4_kofiko = ['\\', kofiko_system, '\', 'StimulusSet', '\', ['abstracted_CIT_faces_01']];
...
for i_matching_file = 1 : n_matching_files
	...
	switch cur_ext
		case {'.jpg', '.tif', '.png', '.bmp', '.jpeg', '.tiff', '.JPG', '.TIF', '.PNG', '.BMP', '.JPEG', '.TIFF'}
			...
			file_properties{i_matching_file} = parse_img_name_v06(proto_file_list(i_matching_file).name);
		otherwise
