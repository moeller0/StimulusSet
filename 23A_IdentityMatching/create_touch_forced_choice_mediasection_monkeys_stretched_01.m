function [ output_args ] = create_touch_forced_choice_mediasection_monkeys_stretched_01( input_args )
...
main_exp_name_string = 'monkeys';	% just a convenient way to include an arbitrary attribute for the whole list
...
max_IDs = 8;	% if not negative restrict the number of IDs to the minimum of max_IDs and existing IDs
...
% no objects
img_selection_list = MONKEY_img_idx;
if (max_IDs > 0)
