function [ output_args ] = create_touch_forced_choice_mediasection_objects_masked_01( input_args )
...
transform_instance = 'randomdot'; % randomdot, randomdot_lp, phase_scramble;	stretched
