function [ output_args ] = create_touch_forced_choice_paradigm_list_randomdot_masked_01( input_args )
...
transform_type = 'masked';
transform_instance = 'randomdot';
...
relative_target_img_dir = fullfile('..' , [transform_type, '_AM_familiarity_02'], transform_instance);	% where to find the potential target images, relative to this script's directory

% what should end up in the xml file, ATTENTION windows pathnames
% recommended
kofiko_system = 'KOFIKO-USER-23A';
abs_img_path_4_kofiko = ['\\', kofiko_system, '\', 'StimulusSet', '\', [transform_type, '_AM_familiarity_02'], '\', transform_instance];
main_exp_name_string = 'ID_match_v02';	% just a convenient way to include an arbitrary attribute for the whole list
